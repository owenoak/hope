// function toTextile(string) parses the string as Textile and returns formatted HTML.
// hide implementation from global scope, returning just the main function
var fromTextile = (function() {
...
function prep(m){
	...
	// #foo links -- if no "foo" bit, uses title of anchor
	m=m.replace(/\"([^\"]+)\":#(\S*)(\S?)/g,function($0,$1,$2,$3){return '<a href="#' + ($2?$2:$1)+'">'+$1+'</a>'});
